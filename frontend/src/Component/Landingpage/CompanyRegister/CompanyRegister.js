...
const companytypepattern=/^[a-zA-Z\s]{2,}$/;
  ...
  const validate = () => {
    ...
    if (!formData.spocName) {
      ...
      formErrors.spocName = "Invalid SPOC name. Only letters and spaces are allowed, minimum 2 characters.";
      isValid = false;
    }
    ...
    <div className="container-fluid p-0 m-0">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label htmlFor="companyName" className="text-start">Company Name</label>
          <input
            type="text"
            name="companyName"
            id="companyName"
          ...
          />
          {errors.companyName && (
            <p className="error-text text-start">{errors.companyName}</p>
          )}
        </div>

        <div className="form-group">
          <label htmlFor="companyEmail" className="text-start">Company Email</label>
          <input
            type="email"
            name="companyEmail"
            id="companyEmail"
          ...
          />
          {errors.companyEmail && (
            <p className="error-text text-start">{errors.companyEmail}</p>
          )}
        </div>

        <div className="form-group">
          <label htmlFor="country" className="text-start">Country</label>
          <input
            type="text"
            name="country"
            id="country"
        ...
        <div className="form-group">
          <label htmlFor="zipcode" className="text-start">Zipcode</label>
          <input
            type="text"
            name="zipcode"
            id="zipcode"
        ...
        <div className="form-group">
          <label htmlFor="companyPhone" className="text-start">Company Phone Number</label>
          <input
            type="text"
            name="companyPhone"
            id="companyPhone"
          ...
          />
          {errors.companyPhone && (
            <p className="error-text text-start">{errors.companyPhone}</p>
          )}
        </div>

        <div className="form-group">
          <label htmlFor="spocName" className="text-start">SPOC Name</label>
          <input
            type="text"
            name="spocName"
            id="spocName"
            ...
            className="frmcontrol"
          />
          {errors.spocName && <p className="error-text text-start">{errors.spocName}</p>}
        </div>
        </div>
        <div className="col-lg-6">
        <div className="form-group">
          <label htmlFor="spocEmail" className="text-start">SPOC Email</label>
          <input
            type="email"
            name="spocEmail"
            id="spocEmail"
            ...
            className="frmcontrol"
          />
          {errors.spocEmail && <p className="error-text text-start">{errors.spocEmail}</p>}
        </div>

        <div className="form-group">
          <label htmlFor="spocPhone" className="text-start">SPOC Phone Number</label>
          <input
            type="text"
            name="spocPhone"
            id="spocPhone"
            ...
            className="frmcontrol"
          />
          {errors.spocPhone && <p className="error-text text-start">{errors.spocPhone}</p>}
        </div>

        <div className="form-group">
          <label htmlFor="companySize" className="text-start">Company Size</label>
          <input
            type="text"
            name="companySize"
            id="companySize"
            ...
            className="frmcontrol"
          />
           {errors.companySize && <p className="error-text text-start">{errors.companySize}</p>}
        </div>

        <div className="form-group">
          <label htmlFor="companyType" className="text-start">Company Type</label>
          <input
            type="text"
            name="companyType"
            id="companyType"
            ...
            className="frmcontrol"
          />
           {errors.companyType && <p className="error-text text-start">{errors.companyType}</p>}
        </div>
  ...
  <div className="d-flex">
    ...
    >
      {showPassword ? <AiFillEye /> : <AiFillEyeInvisible />} {/* Show the correct icon */}
    </span>
  </div>
  {errors.password && <p className="error-text text-start">{errors.password}</p>}
</div>
...
<div className="d-flex justify-content-center">
      ...
      <p className="text-center mt-2">
                Already have an account? <Link to="/login" className="logtext">Log in</Link>
              </p>
    </div>
    </div>
    </div>
